...
app.post("/weather", (req, res) => {
  ...
  axios.get("http://api.worldweatheronline.com/premium/v1/weather.ashx?key=a4820d17519f46ab8c8145354211709&q="+ip+"&format=json&num_of_days=5", {
    data:{
        ip: req.body.ip,
      },
    ...
    /* --------------- Get cities weather by ip-----------------*/
    app.post("/cities", (req, res) => {
      const ip = req.body.data.ip
      //ip = getting the ip of the user from client side
      ...
      axios.get("http://api.worldweatheronline.com/premium/v1/weather.ashx?key=a4820d17519f46ab8c8145354211709&q="+ip+"&format=json&num_of_days=5", {
        ...
        //   console.log(req.body);
        //   // const username = req.body.username;
        //   const citiesWatchlist = [

        //     [req.body.citiesWatchlist],
        //   ];


        
        //     db.query("INSERT INTO users(cities) VALUES (?)",
        //       [[citiesWatchlist]],
        
        //       function (err) {
        //         if (err) throw err;
        //         console.log("Number of records inserted: " + citiesWatchlist);
        //       }
        //     );
        //   })
